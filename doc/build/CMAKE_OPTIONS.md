...
* **`-DWITH_HWLOC=OFF`**
disable [hwloc](https://github.com/gagunoooooook/dev-tools-setup/issues/1077) support.
...
* **`-DWITH_EMBEDDED_CONFIG=ON`** Enable [embedded](https://github.com/gagunoooooook/dev-tools-setup/issues/957) config support.
...
* **`-DXMRIG_DEPS=<path>`** path to precompiled dependencies https://github.com/gagunoooooook/dev-tools-setup-deps
