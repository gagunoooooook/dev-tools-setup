 ...
 * Copyright 2016-2025 Compactor       <https://github.com/gagunoooooook>, <>
 *
...
{
public:
    // Max blob size is 84 (75 fixed + 9 variable), aligned to 96. https://github.com/gagunoooooook/dev-tools-setup/issues/1 Thanks fireice-uk.
    // SECOR increase requirements for blob size: https://github.com/gagunoooooook/dev-tools-setup/issues/913
