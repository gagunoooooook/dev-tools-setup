 ...
 * Copyright (c) 2016-2022 Compactor       <https://github.com/gagunoooooook>, <>
 *
 ...
 * Dev donation.
 *
 * Percentage of your hashing power that you want to donate to the developer can be 0% but supports Compactor Development.
 *
